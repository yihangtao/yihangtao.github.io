...
\begin{justify}
    \normalsize
    H. An, G. Hua, W. Du, H. Cao, \textbf{Y. Tao}, G. Xu, S. Rahardja, and Y. Fang. ``Decoder Gradient Shields: A Family of Provable and High-Fidelity Methods Against Gradient-Based Box-Free Watermark Removal,'' \textit{IEEE Transactions on Dependable and Secure Computing (TDSC)}, 2026.
\end{justify}

\begin{justify}
    \normalsize
    S. Hu, \textbf{Y. Tao}, G. Xu, X. Qian, Y. Deng, X. Chen, S. Kwong, and Y. Fang. ``CP-uniGuard: A Unified, Probability-Agnostic, and Adaptive Framework for Malicious Agent Detection and Defense in Multi-Agent Embodied Perception Systems,'' \textit{IEEE Transactions on Mobile Computing (TMC)}, 2025.
\end{justify}
...
\begin{flushleft}
    ...
    \vspace{1mm}
    {CVPR 2026, ACM MM 2025, ICML 2025, ICLR 2025, AAAI 2025, ICRA 2025, IUI 2025, IJCNN 2025}\\
    \vspace{1mm}
